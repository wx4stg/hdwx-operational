...
def writeJson(basePath, productID, runTime, fileName, validTime, gisInfo, reloadInterval):
    ...
    #     totalFrameCount = -1
        ...
        productDesc = "WTLMA VHF 1-minute Sources"
        productPath = "gisproducts/wtlma/vhf-1min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources"
        productPath = "products/wtlma/vhf-1min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "GR2Analyst WTLMA VHF Sources (1 minute)"
        productPath = "gr2a/"
        isFcst = False
        fileExt = "php"
        dispFrames = 1
        ...
        productDesc = "WTLMA VHF 10-minute Sources"
        productPath = "gisproducts/wtlma/vhf-10min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 10-minute Sources"
        productPath = "products/wtlma/vhf-10min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "GR2Analyst WTLMA VHF Sources (10 minutes)"
        productPath = "gr2a/"
        isFcst = False
        fileExt = "php"
        dispFrames = 60
        ...
        productDesc = "WTLMA 1-minute Flash Extent Density"
        productPath = "gisproducts/wtlma/flash-1min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA 1-minute Flash Extent Density"
        productPath = "products/wtlma/flash-1min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA 10-minute Flash Extent Density"
        productPath = "gisproducts/wtlma/flash-10min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA 10-minute Flash Extent Density"
        productPath = "products/wtlma/flash-10min/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources + ADRAD Reflectivity"
        productPath = "products/wtlma/adrad-src/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources + MRMS Reflectivity At Lowest Altitude"
        productPath = "products/wtlma/mrms-src/"
        isFcst = False
        fileExt = "png"
        dispFrames = 30
        productTypeID = 1
        ...
        productDesc = "WTLMA 1-minute Flash Extent Density + ADRAD Reflectivity"
        productPath = "products/wtlma/adrad-flash/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA 1-minute Flash Extent Density + MRMS Reflectivity At Lowest Altitude"
        productPath = "products/wtlma/mrms-flash/"
        isFcst = False
        fileExt = "png"
        dispFrames = 30
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources Analysis Plot"
        productPath = "products/wtlma/vhf-1min-analysis/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources Analysis Plot"
        productPath = "products/wtlma/vhf-10min-analysis/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
        ...
        productDesc = "WTLMA VHF 1-minute Sources Analysis Plot + MRMS Reflectivity At Lowest Altitude"
        productPath = "products/wtlma/mrms-src-analysis/"
        isFcst = False
        fileExt = "png"
        dispFrames = 60
        productTypeID = 1
    ...
    if productTypeID == 0:
        ...
        productTypeDesc = "TTU Observations"
...
def dressImage(fig, ax, title, validTime, fhour=None, notice=None, plotHandle=None, cbticks=None, tickhighlight=None, cbextend="neither", colorbarLabel=None, width=1920, height=1080, tax=None, lax=None):
    ...
    if notice is None:
        if "ecmwf" in title.lower():
            notice = "Copyright © "+validTime.strftime("%Y")+" European Centre for Medium-Range Weather Forecasts (ECMWF)\nhttps://www.ecmwf.int/"
