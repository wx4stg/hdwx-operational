...
def writeJson(basePath, productID, runTime, fileName, validTime, gisInfo, reloadInterval):
    ...
    if productID == 0:
        ...
        productPath = "products/gfs/500staticvorteurope/"
        isFcst = True
        fileExt = "png"
        dispFrames = 0
        productTypeID = 3
        ...
        productPath = "products/gfs/250staticjeteurope/"
        isFcst = True
        fileExt = "png"
        dispFrames = 0
        productTypeID = 3
        ...
        productPath = "products/gfs/850statictempseurope/"
        isFcst = True
        fileExt = "png"
        dispFrames = 0
        productTypeID = 3
        ...
        productPath = "products/gfs/700staticrheurope/"
        isFcst = True
        fileExt = "png"
        dispFrames = 0
        productTypeID = 3
        ...
        productPath = "products/gfs/4pnleurope/"
        isFcst = True
        fileExt = "png"
        dispFrames = 0
        productTypeID = 3
